...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, t, o) {
   return e == Array.prototype || e == Object.prototype ? e : (e[t] = o.value,
   e)
}
,
...
$jscomp.polyfillIsolated = function(e, t, o, r) {
   ...
   n = n[n.length - 1],
   null != (t = t(o = $jscomp.IS_SYMBOL_NATIVE && "es6" === o ? r[n] : null)) && (e ? $jscomp.defineProperty($jscomp.polyfills, n, {
       configurable: !0,
       writable: !0,
       value: t
   }) : t !== o && ($jscomp.propertyToPolyfillSymbol[n] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(n) : $jscomp.POLYFILL_PREFIX + n,
...
var docSlider = function() {
   var e, t, o, r, n, i, l, a, s, c, u, d, p, f, m, g, h, v, y, b, S, j, $, A, L, C, E = {
       speed: 600,
       easing: "ease",
       pager: !0,
       horizontal: !1,
       ...
       setChangeCss: function(e, t, o, r, n) {
           ...
           e.transitionTimingFunction = r,
           e.transform = "translate" + (n ? "X" : "Y") + "(-" + 100 * t + "%)",
           e
       }
   }, P = function(e) {
       if (void 0 !== e) {
       ...
       for (var r = 0; r < o.length; r++) {
           ...
           n.classList.add("docSlider-page"),
           n.classList.add("docSlider-scroll"),
           n.setAttribute("data-ds-index", r.toString()),
       ...
       if (E.pager) {
           ...
           if (document.querySelector(".docSlider-pager")) {
               ...
               for (var t = 0; t < e.length; t++) {
                   var o = e[t];
                   o.setAttribute("data-ds-jump", t.toString()),
                   o.setAttribute("tabindex", "-1")
               }
           } else {
               for ((t = document.createElement("nav")).classList.add("docSlider-pager"),
               o = 0; o < e; o++) {
                   var r = document.createElement("button");
                   r.classList.add("docSlider-button"),
                   r.setAttribute("data-ds-jump", o.toString()),
       ...
       r = document.querySelector(".docSlider"),
       n = document.querySelectorAll(".docSlider-inner > *"),
       i = document.querySelector(".docSlider-pager"),
       l = document.querySelectorAll(".docSlider-pager .docSlider-button"),
       a = n.length,
       c = s = 0,
       u = E.horizontal ? "X" : "Y",
       d = E.horizontal ? "Y" : "X",
       p = "onwheel"in document ? "wheel" : "onmousewheel"in document ? "mousewheel" : "DOMMouseScroll",
       m = f = !0,
       g = "elementsFromPoint"in document ? "elementsFromPoint" : "msElementsFromPoint",
       h = "ontouchstart"in window,
       v = /iPhone|Android.+Mobile/.test(navigator.userAgent),
       y = 0,
       S = b = null,
       j = !0,
       L = A = $ = null,
       ...
       for (var e = 0; e < a; e++) {
           var t = l[e];
           n[e].addEventListener("focusin", O.focusin),
           void 0 !== t && t.addEventListener("click", O.pagerClick)
       }
       document.addEventListener("keyup", O.keyup),
       document.addEventListener(p, O.wheel),
       n[0].addEventListener("transitionstart", O.transitionstart),
       n[0].addEventListener("transitionend", O.transitionend),
       h && (C = {
           move: !1,
           nextX: "right",
           prevX: "left",
       ...
       r.addEventListener("touchstart", O.touchstart, !1),
       r.addEventListener("touchmove", O.touchmove, !1),
       r.addEventListener("touchend", O.touchend, !1)),
       v && (O.setFV(),
       window.addEventListener("resize", O.resize))
   }, T = function() {
       var e = O.hashToIndex(location.hash);
       return e !== s && (b = null === E.startSpeed ? E.speed : E.startSpeed,
       $ = "anchor",
       ...
       pageChange: function(o) {
           ...
           o !== s) {
               ...
               s = o,
               o = null === b ? E.speed : b;
               for (var r = null === S ? E.easing : S, i = 0; i < a; i++)
                   for (var l = n[i], u = E.setChangeCss(i, s, o, r, E.horizontal), d = 0; d < Object.keys(u).length; d++) {
                       var p = Object.keys(u)[d];
                       l.style[p] = u[p]
                   }
               o || (E.scrollReset && O.scrollReset(n[s]),
               t && O.animationReset(c),
               E.beforeChange(c, n[c], s, n[s], $),
               A = $,
               $ = null,
               e && scrollCue._updateWithDocSlider(),
               E.afterChange(s, n[s], c, n[c], A),
               A = null),
               S = b = null,
               O.updatePager(),
               O.updateClass()
       ...
       updateClass: function() {
           ...
           var i = n[s]
             ...
             , a = Number(l) + 1;
           i = !!i.hasAttribute("id") && i.getAttribute("id"),
           o.classList.remove("docSlider-index_" + t),
           o.classList.remove("docSlider-page_" + r),
           o.classList.remove("docSlider-id_" + e),
           o.classList.add("docSlider-index_" + l),
           o.classList.add("docSlider-page_" + a),
           i && o.classList.add("docSlider-id_" + i),
           n[c].classList.remove("docSlider-current"),
           n[s].classList.add("docSlider-current")
       },
       keyup: function(e) {
           if (j && n[s] === document.activeElement) {
               ...
               e = e.shiftKey;
               var o = n[s];
               if ((e && / |Spacebar/.test(t) || !e && /ArrowUp|Up|PageUp/.test(t)) && O.scrollEnd(o, "top"))
                   t = s - 1;
               else if (!e && / |Spacebar|ArrowDown|Down|PageDown/.test(t) && O.scrollEnd(o, "bottom"))
                   t = s + 1;
               else if (e || "Home" !== t)
                   if (e || "End" !== t)
                       if (!e && E.horizontal && /ArrowLeft|Left/.test(t))
                           t = s - 1;
                       else {
                           if (e || !E.horizontal || !/ArrowRight|Right/.test(t))
                               return;
                           t = s + 1
                       }
                   else
               ...
               j && m) {
                   ...
                   if (L === n[s] && r !== s) {
                       for (var i = 0; i < o.length; i++) {
                           var l = o[i];
                           if (l.classList.contains("docSlider-scroll") && !O.scrollEnd(l, t))
                               return
                       }
                       $ = "scroll",
                       O.pageChange(r)
       ...
       transitionstart: function() {
           m = !1,
           E.scrollReset && O.scrollReset(n[s]),
           t && O.animationReset(c),
           E.beforeChange(c, n[c], s, n[s], $),
           A = $,
           $ = null
       ...
       touchstart: function(e) {
           !j || 1 < e.touches.length || (C.move = !1,
           C.X.start = e.touches[0].pageX,
           C.Y.start = e.touches[0].pageY)
       },
       touchmove: function(e) {
           j && (1 < e.touches.length ? e.preventDefault() : (C.move = !0,
           C.X.move = e.changedTouches[0].pageX,
           C.Y.move = e.changedTouches[0].pageY))
       },
       touchend: function(e) {
           if (!(!j || 1 < e.touches.length || !C.move || (C.X.distance = C.X.move - C.X.start,
           C.Y.distance = C.Y.move - C.Y.start,
           Math.abs(C[u].distance) < Math.abs(C[d].distance)))) {
               ...
               if ((e = O.indexCheck("next" === t ? s + 1 : s - 1)) !== s && !(0 === s && "prev" === t || s === a - 1 && "next" === t)) {
                   ...
                   for (var o = document[g](C.X.start, C.Y.start), r = 0; r < o.length; r++) {
                       var n = o[r];
                       if (n.classList.contains("docSlider-scroll") && !O.scrollEnd(n, t))
                           return
                   }
                   $ = "scroll",
                   O.pageChange(e)
       ...
       animationReset: function(e) {
           ...
           for (var o = 0; o < t.length; o++) {
               ...
               if (r.getAttribute("data-scpage") !== e + "" && (r.removeAttribute("style"),
               r.removeAttribute("data-show"),
               n)) {
                   n = n.split(" ");
                   for (var i = 0; i < n.length; i++)
                       r.classList.remove(n[i])
               }
           }
   ...
   return {
       init: function(o) {
           ...
           x(),
           o = T(),
           e = "undefined" != typeof scrollCue && scrollCue._hasDocSlider(),
           t = "undefined" != typeof scrollCue && scrollCue._hasPageChangeReset(),
           e && scrollCue._initWithDocSlider(o),
           E.complete(E, docSlider.getElements())
       },
       jumpPage: function(e, t, o) {
           void 0 !== e && (e = isNaN(e) ? O.hashToIndex("#" + e.replace("#", "")) : O.indexCheck(0 > e ? a + e : e),
           b = void 0 === t ? null : t,
           S = void 0 === o ? null : o,
           $ = "jumpPage",
           O.pageChange(e))
